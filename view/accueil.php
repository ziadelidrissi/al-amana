...
<body class="font-body">
    ...
    <section>
        ...
        <section class="bg-fixed bg-center bg-no-repeat bg-cover lg:h-screen flex items-center">
            ...
            <div class="flex flex-col gap-40 items-center justify-center mx-auto w-10/12 lg:w-9/12 xl:w-8/12">
        ...
        <div class="my-20">
            ...
            <div class="flex flex-row w-full">
                ...
                <div class="flex flex-grow w-1/2 card bg-base-300 rounded-none hidden md:block">
