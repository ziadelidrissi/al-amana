...
<body class="font-body">
    ...
    <section>
        ...
        <!-- HERO -->
            <div class="hero min-h-screen bg-[url('/img/hero-pattern.svg')]" style="background-image: url(assets/img/hero_accueil.jpeg);">
                <div class="hero-overlay bg-opacity-60"></div>
                <div class="hero-content text-center text-neutral-content">
                    <div class="max-w-md">
                    <h1 class="mb-10 text-7xl font-bold">Al Amana</h1>
                    <p class="mb-5 text-3xl italic">Le prophète ﷺ a dit : "Allah vient en aide au serviteur tant que celui-ci vient en aide à son frère." {Sahih Muslim n°2699}</p>
                    </div>
                </div>
            </div>
        <!-- HERO -->
        ...
        <!-- ACTIVITES -->
        <section class="bg-fixed bg-center bg-no-repeat bg-cover lg:h-screen/2 flex items-center py-32" /style="background-image: url(assets/img/*****/);"/>

            <div class="flex flex-col gap-20 items-center justify-center mx-auto w-10/12 lg:w-9/12 xl:w-8/12 p-12 border-black border-4 drop-shadow-2xl rounded-2xl">
                <h1 class=" text-5xl font-bold text-center">Nos activités</h1>
        
                    <!-- CARDS -->
                    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        <div class="card bg-base-100 shadow-2xl">
                            <div class="card-body">
                                <h2 class="card-title text-center">Accompagnement des personnes en fin de vie</h2>
                            </div>
                            <figure><img class="h-40 w-full object-cover grayscale" src="assets/img/old_people.jpg" alt="activite" /></figure>
                        </div>
        
                        <div class="card bg-base-100 shadow-2xl">
                            <div class="card-body">
                                <h2 class="card-title text-center">Formation à la toilette rituelle</h2>
                            </div>
                            <figure><img class="h-40 w-full object-cover grayscale" src="assets/img/wudu.jpg" alt="activite" /></figure>
                        </div>
        
                        <div class="card bg-base-100 shadow-2xl">
                            <div class="card-body">
                                <h2 class="card-title text-center">Rapatriement & enterrement</h2>
                            </div>
                            <figure><img class="h-40 w-full object-cover grayscale" src="assets/img/graveyard.jpeg" alt="activite" /></figure>
                        </div>
        
                        <div class="card bg-base-100 shadow-2xl">
                            <div class="card-body">
                                <h2 class="card-title text-center">Leçons et cours religieux</h2>
                            </div>
                            <figure><img class="h-40 w-full object-cover grayscale" src="assets/img/lessons.jpeg" alt="activite" /></figure>
                        </div>
                    </div>
                    <!-- CARDS -->
        ...
        <div class="">
            ...
            <div class="flex flex-row w-full lg:h-screen/2">
            ...
            <div class="flex flex-row w-full lg:h-screen/2">
                ...
                <div class="hidden md:flex flex-grow w-1/2 card bg-base-300 rounded-none">
                    <img class="h-full w-full object-cover" src="assets/img/advices.jpeg" alt="">
                </div>
            </div>
